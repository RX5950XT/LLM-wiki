...
interface PageDao {
    ...
    @Query("UPDATE pages SET content = :content, version = :version WHERE workspace_id = :workspaceId AND account_name = :accountName AND slug = :slug")
    suspend fun updateContentAndVersion(
        workspaceId: String,
        accountName: String,
        slug: String,
        content: String,
